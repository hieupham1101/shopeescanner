...
;
;
const db = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$idb$2f$build$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["openDB"])("shopee-pack-check", 1, {
        upgrade (db) {
...
async function loadData() {
    ...
    return {
        orders,
        metadata: metadata,
        counters: counters ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$scan$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["emptyCounters"])()
    };
}
async function saveDataset(data, clear) {
    ...
    if (clear) {
        ...
        void tx.objectStore("meta").put((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$scan$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["emptyCounters"])(), "counters");
    }
    await tx.done;
}
async function commitScan(record) {
    ...
    const counters = await tx.objectStore("meta").get("counters") ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$scan$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["emptyCounters"])();
...
async function resetHistory() {
    ...
    await Promise.all([
        ...
        tx.objectStore("meta").put((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$scan$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["emptyCounters"])(), "counters")
    ]);
    await tx.done;
}
...
//# sourceMappingURL=_0qutrwd._.js.map