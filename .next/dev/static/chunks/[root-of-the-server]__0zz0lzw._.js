        ...
        "PackCheck.useEffect": ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadData"])().then({
                "PackCheck.useEffect": async (data)=>{
                    ...
                    processor.current = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$scanProcessor$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScanProcessor"]();
...
_s(PackCheck, "qowc488yK/8DsCbpUNrZpAHKwF4=");
_c = PackCheck;
var _c;
...
class ScanProcessor {
    ...
    queue;
    failed;
    constructor(submit = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["commitScan"]){
        this.submit = submit;
...
async function request(path = '', body) {
    const response = await fetch('/api/pack-check' + path, {
        ...
        cache: 'no-store',
        signal: AbortSignal.timeout(body ? 60000 : 15000)
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0zz0lzw._.js.map