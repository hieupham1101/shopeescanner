...
function PackCheck() {
        ...
        "PackCheck.useEffect": ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadData"])().then({
                "PackCheck.useEffect": async (data)=>{
                    ...
                    processor.current = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$scanProcessor$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScanProcessor"](new Map(data.orders.map({
                        "PackCheck.useEffect": (o)=>[
                                o.trackingCode,
                                o
                            ]
                    }["PackCheck.useEffect"])));
                ...
                "PackCheck.useEffect": ()=>setError("Local storage could not be opened. Scanning is stopped. Enable site storage and reload.")
            }["PackCheck.useEffect"]);
            try {
        ...
        "PackCheck.useCallback[processScan]": (code, source = "manual")=>{
            ...
            void processor.current.processScan(code, source).then({
                ...
                "PackCheck.useCallback[processScan]": ()=>{
                    ...
                    setResult(null);
                    setError("STOP — scan could not be saved. No parcel is approved. Reload to restore storage before scanning again.");
    ...
    async function commitImport(data, clear) {
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveDataset"])(data, clear);
            processor.current = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$scanProcessor$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScanProcessor"](new Map(data.orders.map((o)=>[
                    o.trackingCode,
                    o
                ])));
            setMetadata(data.metadata);
            if (clear) setCounters((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$scan$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emptyCounters"])());
            setHistory(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["readHistory"])());
            setPage(0);
            setView("station");
            setResult(null);
            ...
            setError("Import could not be saved. Your previous data is unchanged. Check available device storage.");
        } finally{
            setBusy(false);
        }
    }
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("small", {
                                        children: ready ? "All data stays on this device" : "Restoring local workspace…"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/PackCheck.tsx",
                                        lineNumber: 401,
                                        columnNumber: 13
...
_s(PackCheck, "Hn0rXYk5tLWqt9emhM4O2VnAwmY=");
_c = PackCheck;
var _c;
...
class ScanProcessor {
    ...
    processScan(rawCode, source = "manual") {
        ...
        const job = this.queue.then(async ()=>{
            const order = this.orders.get(trackingCode);
            const availability = order ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$orderStatus$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["determineOrderStatus"])(order) : null;
            const status = !order ? "UNKNOWN" : availability === "AVAILABLE" ? "ACCEPTED" : availability;
            const saved = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["commitScan"])({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1zknqmu._.js.map