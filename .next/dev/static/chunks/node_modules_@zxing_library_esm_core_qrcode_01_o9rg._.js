 ...
 */ /*namespace com.google.zxing.qrcode {*/ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$library$2f$esm$2f$core$2f$BarcodeFormat$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@zxing/library/esm/core/BarcodeFormat.js [app-client] (ecmascript)");
 ...
 */ var QRCodeReader = function() {
     ...
     */ QRCodeReader.extractPureBits = function(image) {
        ...
        var moduleSize /*float*/  = this.moduleSize(leftTopBlack, image);
...
"[project]/node_modules/@zxing/library/esm/core/qrcode/QRCodeReader.js [app-client] (ecmascript) <export default as QRCodeReader>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "QRCodeReader",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$library$2f$esm$2f$core$2f$qrcode$2f$QRCodeReader$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
 ...
 */ var QRCodeWriter = function() {
    ...
    /*@Override*/ QRCodeWriter.prototype.encode = function(contents, format, width /*int*/ , height /*int*/ , hints) {
        ...
        if (width < 0 || height < 0) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$library$2f$esm$2f$core$2f$IllegalArgumentException$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]("Requested dimensions are too small: ".concat(width, "x").concat(height));
        }
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ /*namespace com.google.zxing.qrcode.decoder {*/ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$library$2f$esm$2f$core$2f$common$2f$BitSource$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@zxing/library/esm/core/common/BitSource.js [app-client] (ecmascript)");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ /*namespace com.google.zxing.qrcode.decoder {*/ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$library$2f$esm$2f$core$2f$ArgumentException$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@zxing/library/esm/core/ArgumentException.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$library$2f$esm$2f$core$2f$IllegalArgumentException$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@zxing/library/esm/core/IllegalArgumentException.js [app-client] (ecmascript)");
;
;
...
"[project]/node_modules/@zxing/library/esm/core/qrcode/decoder/ErrorCorrectionLevel.js [app-client] (ecmascript) <export default as QRCodeDecoderErrorCorrectionLevel>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "QRCodeDecoderErrorCorrectionLevel",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$library$2f$esm$2f$core$2f$qrcode$2f$decoder$2f$ErrorCorrectionLevel$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$library$2f$esm$2f$core$2f$qrcode$2f$decoder$2f$ErrorCorrectionLevel$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@zxing/library/esm/core/qrcode/decoder/ErrorCorrectionLevel.js [app-client] (ecmascript)");
}),
 ...
 */ var AlignmentPattern = function(_super) {
     ...
     */ AlignmentPattern.prototype.aboutEquals = function(moduleSize /*float*/ , i /*float*/ , j /*float*/ ) {
        if (Math.abs(i - this.getY()) <= moduleSize && Math.abs(j - this.getX()) <= moduleSize) {
            var moduleSizeDiff /*float*/  = Math.abs(moduleSize - this.estimatedModuleSize);
     ...
     */ AlignmentPattern.prototype.combineEstimate = function(i /*float*/ , j /*float*/ , newModuleSize /*float*/ ) {
        var combinedX /*float*/  = (this.getX() + j) / 2.0;
        var combinedY /*float*/  = (this.getY() + i) / 2.0;
        var combinedModuleSize /*float*/  = (this.estimatedModuleSize + newModuleSize) / 2.0;
 ...
 */ var AlignmentPatternFinder = function() {
     ...
     */ AlignmentPatternFinder.prototype.foundPatternCross = function(stateCount) {
        var moduleSize /*float*/  = this.moduleSize;
        var maxVariance /*float*/  = moduleSize / 2.0;
        for(var i = 0; i < 3; i++){
     ...
     */ AlignmentPatternFinder.prototype.handlePossibleCenter = function(stateCount, i /*int*/ , j /*int*/ ) {
        var e_1, _a;
        var stateCountTotal = stateCount[0] + stateCount[1] + stateCount[2];
        var centerJ /*float*/  = AlignmentPatternFinder.centerFromEnd(stateCount, j);
        var centerI /*float*/  = this.crossCheckVertical(i, /*(int) */ centerJ, 2 * stateCount[1], stateCountTotal);
        if (!isNaN(centerI)) {
            var estimatedModuleSize /*float*/  = (stateCount[0] + stateCount[1] + stateCount[2]) / 3.0;
            try {
 ...
 */ var Detector = function() {
    ...
    Detector.prototype.processFinderPatternInfo = function(info) {
        ...
        var moduleSize /*float*/  = this.calculateModuleSize(topLeft, topRight, bottomLeft);
        if (moduleSize < 1.0) {
        ...
        if (provisionalVersion.getAlignmentPatternCenters().length > 0) {
            ...
            var bottomRightX /*float*/  = topRight.getX() - topLeft.getX() + bottomLeft.getX();
            var bottomRightY /*float*/  = topRight.getY() - topLeft.getY() + bottomLeft.getY();
            // Estimate that alignment pattern is closer by 3 modules
            // from "bottom right" to known top left location
            var correctionToTopLeft /*float*/  = 1.0 - 3.0 / modulesBetweenFPCenters;
    ...
    Detector.createTransform = function(topLeft, topRight, bottomLeft, alignmentPattern, dimension /*int*/ ) {
        var dimMinusThree /*float*/  = dimension - 3.5;
     ...
     */ Detector.prototype.calculateModuleSizeOneWay = function(pattern, otherPattern) {
        var moduleSizeEst1 /*float*/  = this.sizeOfBlackWhiteBlackRunBothWays(/*(int) */ Math.floor(pattern.getX()), /*(int) */ Math.floor(pattern.getY()), /*(int) */ Math.floor(otherPattern.getX()), /*(int) */ Math.floor(otherPattern.getY()));
        var moduleSizeEst2 /*float*/  = this.sizeOfBlackWhiteBlackRunBothWays(/*(int) */ Math.floor(otherPattern.getX()), /*(int) */ Math.floor(otherPattern.getY()), /*(int) */ Math.floor(pattern.getX()), /*(int) */ Math.floor(pattern.getY()));
     ...
     */ Detector.prototype.sizeOfBlackWhiteBlackRunBothWays = function(fromX /*int*/ , fromY /*int*/ , toX /*int*/ , toY /*int*/ ) {
        var result /*float*/  = this.sizeOfBlackWhiteBlackRun(fromX, fromY, toX, toY);
 ...
 */ var FinderPattern = function(_super) {
     ...
     */ FinderPattern.prototype.combineEstimate = function(i /*float*/ , j /*float*/ , newModuleSize /*float*/ ) {
        ...
        var combinedX /*float*/  = (this.count * this.getX() + j) / combinedCount;
        var combinedY /*float*/  = (this.count * this.getY() + i) / combinedCount;
        var combinedModuleSize /*float*/  = (this.count * this.estimatedModuleSize + newModuleSize) / combinedCount;
 ...
 */ var FinderPatternFinder = function() {
     ...
     */ FinderPatternFinder.foundPatternCross = function(stateCount) {
        ...
        var moduleSize /*float*/  = totalModuleSize / 7.0;
        var maxVariance /*float*/  = moduleSize / 2.0;
     ...
     */ FinderPatternFinder.prototype.handlePossibleCenter = function(stateCount, i /*int*/ , j /*int*/ , pureBarcode) {
        var stateCountTotal = stateCount[0] + stateCount[1] + stateCount[2] + stateCount[3] + stateCount[4];
        var centerJ /*float*/  = FinderPatternFinder.centerFromEnd(stateCount, j);
        var centerI /*float*/  = this.crossCheckVertical(i, /*(int) */ Math.floor(centerJ), stateCount[2], stateCountTotal);
        if (!isNaN(centerI)) {
            // Re-cross check
            ...
            if (!isNaN(centerJ) && (!pureBarcode || this.crossCheckDiagonal(/*(int) */ Math.floor(centerI), /*(int) */ Math.floor(centerJ), stateCount[2], stateCountTotal))) {
                var estimatedModuleSize /*float*/  = stateCountTotal / 7.0;
                var found = false;
     ...
     */ FinderPatternFinder.prototype.haveMultiplyConfirmedCenters = function() {
        ...
        var average /*float*/  = totalModuleSize / max;
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ /*namespace com.google.zxing.qrcode.encoder {*/ var BlockPair = function() {
...
"[project]/node_modules/@zxing/library/esm/core/qrcode/encoder/Encoder.js [app-client] (ecmascript) <export default as QRCodeEncoder>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "QRCodeEncoder",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$library$2f$esm$2f$core$2f$qrcode$2f$encoder$2f$Encoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$library$2f$esm$2f$core$2f$qrcode$2f$encoder$2f$Encoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@zxing/library/esm/core/qrcode/encoder/Encoder.js [app-client] (ecmascript)");
}),
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ /*namespace com.google.zxing.qrcode.encoder {*/ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$library$2f$esm$2f$core$2f$common$2f$BitArray$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@zxing/library/esm/core/common/BitArray.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$library$2f$esm$2f$core$2f$util$2f$Integer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@zxing/library/esm/core/util/Integer.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$library$2f$esm$2f$core$2f$qrcode$2f$encoder$2f$QRCode$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@zxing/library/esm/core/qrcode/encoder/QRCode.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$library$2f$esm$2f$core$2f$qrcode$2f$encoder$2f$MaskUtil$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@zxing/library/esm/core/qrcode/encoder/MaskUtil.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$zxing$2f$library$2f$esm$2f$core$2f$WriterException$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@zxing/library/esm/core/WriterException.js [app-client] (ecmascript)");
...
//# sourceMappingURL=node_modules_%40zxing_library_esm_core_qrcode_01_o9rg._.js.map