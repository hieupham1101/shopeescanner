...
// Validate ../../../src/app/api/pack-check/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/pack-check">> = Specific
  const handler = {} as typeof import("../../../src/app/api/pack-check/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
